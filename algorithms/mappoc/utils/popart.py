...
# Normalization of Policy and Advantage Re-estimation Target
...
class PopArt(torch.nn.Module):
    ...
    def reset_parameters(self):
        ...
        # Initializes the weights of the neural network layer using Kaiming
    ...
    def update(self, input_vector):
        ...
        # his method updates the normalization statistics (mean, mean_sq) using the new data (input_vector).
        # Also updates the weight and bias to adjust for changes in the normali zation.
