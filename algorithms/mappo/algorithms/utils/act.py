...
# is designed to handle different types of action spaces for reinforcement learning
...
class ACTLayer(nn.Module):
    ...
    def get_probs(self, x, available_actions=None):
        ...
        return action_probs
        # 仅仅基于输入，without taking any action
    ...
    def evaluate_actions(self, x, action, available_actions=None, active_masks=None):
        ...
        # 这边action是给的
        #         Compute log probability and entropy of given actions.
        # Entropy is a concept from information theory that measures the randomness
        #  or unpredictability of a distribution. In the context of reinforcement
        #  learning, especially in policy gradient methods, the entropy of the 
        # action distribution is often considered to encourage exploration.
