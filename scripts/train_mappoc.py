...
def main(args):
    ...
    print(envs.action_space('agent_0')[0])
    print(envs.action_space('agent_0')[1])
    # Tuple(Box(-1.0, 1.0, (2,), float32), Discrete(2))
    # Horizontal movement (action[0]): Ranges from -1 to 1.对应作用
    # Vertical movement (action[1]): Ranges from -1 to 1.对应上下
