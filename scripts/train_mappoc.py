...
def train(seed, num_options, app, saves ,wsaves, epoch, dc, num, render ,timesteps_per_batch, comm_weight, explo_iters,\
    ...
    from algorithms.mappoc import MLPformappoc, shared_buffer
    ...
    def policy_fn(q_space, ac_space, pi_space, mu_space, num):
        return MLPformappoc.MLPBase(
                                    hid_size=neurons,
    ...
    # start learning
    shared_buffer.learn(env, policy_fn,
